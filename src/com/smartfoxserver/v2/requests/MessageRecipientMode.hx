...
extern class MessageRecipientMode {
	public static var TO_GROUP(default, never):Int;

	public static var TO_ROOM(default, never):Int;

	public static var TO_USER(default, never):Int;

	public static var TO_ZONE(default, never):Int;
