...
interface Buddy {
	 ...
	 * @see		#getVariable()
	 */
	var variables(get, null):Array<Dynamic>;
	 ...
	 */
	function getVariable(varName:String):Dynamic;
	 ...
	 */
	function getOfflineVariables():Array<Dynamic>;
	 ...
	 * @see		com.smartfoxserver.v2.entities.variables.BuddyVariable#isOffline BuddyVariable.isOffline
	 */
	function getOnlineVariables():Array<Dynamic>;

	/** @private */
	function setVariable(bVar:Dynamic):Void;

	/** @private */
	function setVariables(variables:Array<Dynamic>):Void;
